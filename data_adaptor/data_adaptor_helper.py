...
class WindowGenerator:
    ...
    def __repr__(self):
        return '\n'.join([
            'Total window size: {0}'.format(self.total_window_size),
            'Input indices: {0}'.format(self.input_indices),
            'Label indices: {0}'.format(self.label_indices),
            'Label column name(s): {0}'.format(self.label_columns)])
